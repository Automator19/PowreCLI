...
{ # Start Process  
    ...
    function ESXi-Upgrade-Gen8 {
        ...
        $argsInstall.depot = "/path/HPE-ESXi-6.5.0-Update3-preGen9-650.U3.9.6.10.1"
        $argsInstall.profile = “”
    ...
    function Send-email {
        Send-MailMessage -to "user@emai.com" -from esxiupgrade@gbvdcts374.com -Subject "$esxi - Upgrade Completed!" -SmtpServer smtp.server.com
    }
